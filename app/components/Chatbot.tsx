...
const Chatbot = () => {
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {isOpen && (
          <div id="chatbox-wrapper" className="fixed inset-0 z-20 flex items-center justify-center">
            <motion.div
              ...
              style={{ maxHeight: '75vh', paddingTop: '1rem', paddingBottom: '3rem' }} // Added padding top and bottom
            >
              ...
              <div className="overflow-y-auto" style={{ height: 'calc(75vh - 4rem)' }}>
                {messages.map((message, index) => (
                  ...
                  >
                    ...
                    <div className={`${message.role === 'user' ? 'bg-blue-100' : 'bg-gray-200'} m-2 p-2 rounded-lg`}>
                      {message.content}
                    </div>
                  </div>
                ))}
              ...
              <form
                ...
                className="absolute bottom-0 left-0 right-0 flex items-center bg-white p-4"
              >
                <input
                  type="text"
                  value={input}
